...
public class AgencyLaboursTextViewActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agency_labours_text_view);
            recyclerView=(RecyclerView)findViewById(R.id.agency_view_labours_textview);

            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(new LinearLayoutManager(this));
            listing = new ArrayList<>();
            Intent intent = getIntent();
             current_agency_id=intent.getStringExtra("agency_current_id");
    ...
    private void loadRecyclerviewData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ur_link, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("agency_id",current_agency_id );
                return params;
            }
        };
